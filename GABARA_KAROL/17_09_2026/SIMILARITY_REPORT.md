...
Pupil folder: `GABARA_KAROL`

| your file | similarity | length |
|---|---|---|
| `GABARA_KAROL/17_09_2026/grades.py` | **100%** | 169 chars |
| `GABARA_KAROL/17_09_2026/invetory.py` | **100%** | 249 chars |
| `GABARA_KAROL/17_09_2026/matrix.py` | **100%** | 248 chars |
| `GABARA_KAROL/17_09_2026/week.py` | **100%** | 123 chars |
